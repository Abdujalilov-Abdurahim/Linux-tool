...
from tools.dnsenum_tool import run_dnsenum
from tools.john_tool import run_john
from tools.wpscan_tool import run_wpscan
from tools.netcat_tool import run_netcat
from tools.gobuster_tool import run_gobuster
from tools.enum4linux_tool import run_enum4linux
...
Main = colored("🛡  Offensive Security Toolkit  🧠", "red", attrs=["bold"])
